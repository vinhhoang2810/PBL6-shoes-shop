!(function (e, t) {
  ...
  de.accessor([
    ...
    q.reduceDescriptors(de.prototype, function (e, t) {
      var n = e.value,
      ...
      function (e) {
        return new Promise(function (t, n) {
          ...
          if (
            ...
            (c.onabort = function () {
              c &&
                (n(new M("Request aborted", M.ECONNABORTED, e, c)), (c = null));
            }),
            (c.onerror = function () {
          ...
          void 0 === i && a.setContentType(null),
            ...
            "function" == typeof e.onDownloadProgress &&
              c.addEventListener("progress", we(e.onDownloadProgress, !0)),
            "function" == typeof e.onUploadProgress &&
              c.upload &&
              c.upload.addEventListener("progress", we(e.onUploadProgress)),
            (e.cancelToken || e.signal) &&
              ((r = function (t) {
                c &&
                  (n(!t || t.type ? new ve(null, e, c) : t),
                  c.abort(),
                  (c = null));
              }),
  ...
  var Oe = function (e) {
    ...
    Re = function (e) {
      for (
        var t, n, r = (e = q.isArray(e) ? e : [e]).length, i = {}, a = 0;
        a < r;
        a++
      ) {
        var s = void 0;
        if (
          ((n = t = e[a]),
          !Se(t) && void 0 === (n = Ee[(s = String(t)).toLowerCase()]))
        )
          throw new M("Unknown adapter '".concat(s, "'"));
        if (n) break;
        i[s || "#" + a] = n;
      }
      if (!n) {
  ...
  function Te(e) {
    return (
      ...
      Re(e.adapter || ae.adapter)(e).then(
        function (t) {
          return (
            Ae(e),
      ...
      return (
        r(e, [
          ...
          },
          {
            ...
            value: function (e) {
              return Y(
                be((e = Ce(this.defaults, e)).baseURL, e.url),
                e.params,
                e.paramsSerializer
              );
            },
  ...
  var Ie = (function e(t) {
    ...
    return (
      q.extend(r, Fe.prototype, n, { allOwnKeys: !0 }),
